...
export const fetchArticle = () => axios.get(`${API_SNAPI}/articles?_limit=10`);
export const fetchBlog = () => axios.get(`${API_SNAPI}/blogs?_limit=10`);
export const fetchReport = () => axios.get(`${API_SNAPI}/reports?_limit=10`);
